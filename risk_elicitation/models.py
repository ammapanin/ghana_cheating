...
class Player(BasePlayer):
    dump_risk = models.StringField(
         doc='to store the list of risk decisions')
    rand = models.FloatField(
         doc='random defining which of two options in a chosen lottery will work')
    selected_lottery = models.IntegerField(
         doc='which specific lottery is chosen for payment')
